...
uselesslabelone.Text = "Anti Afk  By hassanxzayn"
...
uselesslabelfour.Text = "Anti-AFK is Enabled"
...
game.StarterGui:SetCore("SendNotification", {
    Title = "Made by hassanxzayn";
    Text = "Thank you for using my script. If you encounter any issues, please feel free to email me at hassanxzayn@gmail.com";
})
